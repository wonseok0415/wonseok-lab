...
- **⚠ 발표자료 관리 주체 변경**: 사용자가 회사 PC에서 pptx를 직접 수정함 — **이후 build_report_deck.js로 재생성하면 사용자 수정분이 덮어써짐.** PPT 관련 작업 전 반드시 어느 쪽이 기준인지 확인하고, 필요 시 사용자 수정 내용을 PROGRESS_REPORT.md/스크립트에 역반영 후 재생성할 것
